			...
			<Row className="pt-lg-4">
				<Col sm={9}>
					...
					<div className="ps-md-4">
						<p>If you experience a manufacturing defect in materials, <span className="fst-italic ">Travel @ Style</span> warrants your steamer  and all of your accessories for the lifetime of the product. We will repair or replace the product at no charge.</p>

						<p>To receive your warranty&nbsp;
